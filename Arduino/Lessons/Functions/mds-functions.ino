...
// Variables
static int ledPin = 13;    //  LED light is connected to Pin 13 (static means it does not change, int means integer)
...
/*
  Set global variables onTime and offTime based on the state of a pushbutton
*/
...
/*  
  Toggle LED on and off using the times in global variables onTime and offTime
*/
